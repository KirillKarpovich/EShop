...
class ProfileTableCell: UITableViewCell {
    ...
    private func configure() {
        ...
        disclosureImageView.anchor(top: topAnchor, leading: nil, bottom: bottomAnchor, trailing: trailingAnchor, padding: .init(top: contentView.frame.size.height/1.7, left: 0, bottom: contentView.frame.size.height/1.7, right: 20))
